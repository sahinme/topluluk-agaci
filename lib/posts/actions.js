...
export const HANDLE_PIN_POST_REQUEST = 'HANDLE_PIN_POST_REQUEST';
export const HANDLE_PIN_POST_SUCCESS = 'HANDLE_PIN_POST_SUCCESS';
export const HANDLE_PIN_POST_FAILURE = 'HANDLE_PIN_POST_FAILURE';
...
export const handlePinPostRequest = (payload) => ({
  type: HANDLE_PIN_POST_REQUEST,
  payload
});
