...
export const HANDLE_MOD_REQUEST = 'HANDLE_MOD_REQUEST';
export const HANDLE_MOD_SUCCESS = 'HANDLE_MOD_SUCCESS';
export const HANDLE_MOD_FAILURE = 'HANDLE_MOD_FAILURE';
...
export const handleModRequest = (payload) => ({
  type: HANDLE_MOD_REQUEST,
  payload
});